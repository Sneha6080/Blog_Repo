...
import com.sneha.blogging.config.AppConstants;
...
public class PostController {
	...
	//Delete Post
		...
		public ResponseEntity<APIReasponse> deletePost(@PathVariable Integer postId){
			this.postService.delete(postId);
			return new ResponseEntity<APIReasponse>(new APIReasponse("post is successfully deleted", true), HttpStatus.OK);
		}
